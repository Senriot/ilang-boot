<template>
  <a-card :bordered="false">
    ...
    <dz-xiexi-video-modal ref="modalForm" @ok="modalFormOk"></dz-xiexi-video-modal>
  </a-card>
</template>
...
<script>
  ...
  import DzXiexiVideoModal from './modules/DzXiexiVideoModal'
  import {filterMultiDictText} from '@/components/dict/JDictSelectUtil'

  export default {
    name: 'DzXiexiVideoList',
    ...
    methods: {
      ...
      getSuperFieldList(){
        ...
        fieldList.push({type:'string',value:'mediaType',text:'媒体类别',dictCode:'media_type'})
