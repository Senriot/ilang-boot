  ...
  export default {
    ...
    data () {
      return {
        ...
        validatorRules: {
          code: {
            rules: [
              ...
              { validator: (rule, value, callback) => validateDuplicateValue('ilang_iot_switch', 'code', value, this.model.id, callback)},
            ]
          },
          name: {
            rules: [
        ...
        url: {
          add: "/ilang/switch/add",
          edit: "/ilang/switch/edit",
          queryById: "/ilang/switch/queryById"
        }
      }
    },
    computed: {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'code','name','ip','city','address','status'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'code','name','ip','city','address','status'))
      },
    }
  }
</script>