        ...
        <a-row>
          ...
          <a-col :span="24">
            <a-form-item label="拼音" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['pinyin']" placeholder="请输入拼音"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="字幕" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea v-decorator="['subtitle']" rows="4" placeholder="请输入字幕" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="音频地址" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-input v-decorator="['audioUrl']" placeholder="请输入音频地址"  ></a-input>
            </a-form-item>
          </a-col>
          <a-col :span="24">
            <a-form-item label="背景图片" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-image-upload isMultiple  v-decorator="['bgPic']" ></j-image-upload>
            </a-form-item>
          </a-col>
          <a-col :span="24">
          ...
          <a-col :span="24">
            <a-form-item label="简介" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <a-textarea v-decorator="['remark']" rows="4" placeholder="请输入简介" />
            </a-form-item>
          </a-col>
          <a-col :span="24">
  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','pinyin','type','typeText','pic','subtitle','audioUrl','bgPic','readCount','duration','remark','status'))
        })
      },
      //渲染流程表单数据
      showFlowData(){
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','pinyin','type','typeText','pic','subtitle','audioUrl','bgPic','readCount','duration','remark','status'))
      },
